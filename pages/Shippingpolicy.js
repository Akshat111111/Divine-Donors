...
export default function Shipping() {
    ...
    return (<div>
        ...
        <p>This document sets out the shipping policy that applies to customers that use this application . If you have any questions, please contact our customer service team  <strong>akshat.sharma.pandri@gmail.com</strong>
        </p>
        <div className="container">
            ...
            <div className=" row p-3 ">
                ...
                <div className="col-md-7 text-center">
                    <h5 className="mt-4">            All orders placed before 12 PM Monday to Friday are processed and dispatched the same day, all orders placed after will be dispatched the next day. All orders placed during the weekend or on a public holiday will be sent from our warehouse on Monday or on the next business day.
                    </h5>
                </div>
