...
export default function FundraiserPlace() {
    ...
    return (<div className="fundraiser-wrap">
        <Head>
            ...
            <meta property="title" content="DIVINE Donors | Help Us To Donate Money and  Books For Your School!" key="title" />
            ...
            <meta property="og:title" content="DIVINE Donors | Help Us To Donate Money and  Books For Your School!" key="title" />
        ...
        <main>
            ...
            <div className="fundraiser-section center-align">
                ...
                <Grid container spacing={4}>
                    ...
                    <Grid item xs={12} sm={`${(topDonors.length > 0) ? 7 : 12}`} className="about-wrap">
                        <div className="about">
                            <p>DIVINE Donors aims to distribute spiritual and inspirational books to school libraries through respective alumni of the school.You can contribute your choice amount on this platform to gift amazing books and other things of wisdom to your own school or college library. 
