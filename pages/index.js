  ...
  return (
    <div className="home-wrap">
      <Head>
        ...
        <meta property="title" content="DIVINE DONORS | Help Us To Donate Books To Your School/University!" key="title" />
        ...
        <meta property="og:title" content="DIVINE DONORS | Help Us To Donate Books To  Your School/University!" key="title" />
      ...
      <main className="main-banner">
        ...
        <div className="banner-wrap center-align position-relative">
          <h1><p style={{marginBottom: "0.25rem"}}>Helping You To Donate</p> <p style={{margin: "0"}}> Books For Your School / College !</p></h1>
        ...
        <Slider dots={true} autoplay={true} speed={2000}>
          ...
          <div className="slide2">            
            {/* <Grid container spacing={4}>
              <Grid item sm={6}>
                <div className="text">
                  <h1>How does DIVINE DONORS work?</h1>
                  <p>The DIVINE DONORS is a Crowdfunding platform where alumni can find their school & sponsor their choice amount or can gift spiritual literature as gratitude for their schools. They can also share this Campaign with other alumni to quickly complete the target.</p>
                </div>
              </Grid>
              <Grid item sm={6}>
                ...
                <div className="text">
                  <h1>How does DIVINE DONORS work?</h1>
                  <p>The DIVINE DONORS is a Crowdfunding platform where alumni can find their school & sponsor their choice amount or gift spiritual literature as gratitude for their schools. They can also share this Campaign with other alumni to quickly complete the target.</p>
                </div>
          </div>
        </Slider>
      </div>
