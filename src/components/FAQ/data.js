export const faqs = {
  data: [
    {
      question: "What is the purpose of DIVINE Donors?",
      answer:
        "The purpose of the DIVINE Donors is to make spiritual wisdom literature available in the school and college libraries. Children need a strong foundation of moral values, the ability to handle emotionally turbulent situations, strong determination, and healthy habits, all these needs can be effectively fulfilled by spiritual literature. They also instill within us healthy pride about our own native culture and heritage and explain the deeper meanings behind them.DIVINE Donors is committed to gift this literature to the schools.",
    },
    {
      question: "How does DIVINE Donors work?",
      answer:
        "The DIVINE Donors is a Crowdfunding platform where alumni can find their school or college & sponsor their choice amount to gift spiritual literature as gratitude for their schools. They can also share this campaign with other alumni to quickly complete the target.",
    },
    {
